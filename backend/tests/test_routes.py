...
def test_valid_remap_n_sort_jobs(
    ...
    payload = {
        "user_data_dict": {"target_job_roles": ["Software Engineer"], "primary_competencies": ["Python"], "secondary_competencies": []},
        "organised_job_result": [{"job_id": "123", "title": "Software Engineer", "description": "Build APIs with Python", "core_skills": ["Python"]}]
    }
    ...
    mock_store_data.assert_any_call(ANY, "job_data", "mock_test_uid_123", supabase_client=ANY)
